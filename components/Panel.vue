<template>
  <section
    class="flex flex-col items-center pb-4 bg-[#F7F8FA] h-svh border border-r border-l-0 border-t-0 border-y-0"
  >
    <div class=" h-[10vh] flex items-center justify-center">
      <img src="../assets/vector.svg" alt="" />
    </div>
    <div class=" flex flex-col gap-[20px] mb-[20px]"><button>
    ...
    >
      <button>
        <img src="../assets/sun.svg" alt="" class=" bg-[#35CAA5] rounded-full p-1 xl:p-2" />
      </button>
      <button>
